...
latlng = '37.760930,-122.446006' # Eric's office (ish)
  # Set a search distance
radius = '4mi'
  # See tweepy API reference for format specifications
geocode_query = latlng + ',' + radius
  # set output file location
file_name = 'data/homeless_SF.json'
...
# df = pd.read_json('path/example_json.json')//prepared for later use of the downloaded data.
...
tweets.to_csv('homeless_SF.csv', sep=',', encoding='utf-8')
